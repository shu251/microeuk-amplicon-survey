...
```{r Plot total ASV and sequences, fig.height=11, fig.width=14}
# head(asv_wtax)
library(viridis)
# svg("../../../../Manuscripts_presentations_reviews/deepsea-microeuk-ME/vectorgraphic-figures/figs1-seqstats.svg", h=11, w = 14)
plot_grid(
...
```{r Investigate sequence and sample QC, fig.height=8, fig.width=15}
