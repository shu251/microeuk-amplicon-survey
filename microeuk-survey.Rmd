...
* Axial seamount timeseries
* Mid-Cayman Rise 2020 cruisee
...
```{r Load librarys for richness estimation}
...
### All samples
```{r Shannon and simpson for all samples plot grid, fig.height=8, fig.width=5}
...
```{r Save Shannon all points, fig.height=5, fig.width=5}
...
```{r Shannon and simpson by type, fig.height=5, fig.width=3}
...
```{r Shannon and simpson for all samples, fig.height=7, fig.width=4}
...
Yes it is - probably need to remove this sample!
## Tile plot CLR: Axial

```{r Isolate axial data and CLR, fig.height=11, fig.width=8}
...
```{r Barplot MCR, tidy=FALSE, fig.height=10, fig.width=11}
...
# Incorporate grazing data and metadata
